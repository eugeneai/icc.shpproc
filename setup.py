...
ext_modules=[
#    Extension("icc.shpproc.cython_module",
#              sources=["src/icc/shpproc/cython_module.pyx"],
#              libraries=["gdal"],
#    )
]
...
setup(
    name='icc.shpproc',
    version=version,
    description="Shapefile processing routines for a special domain tasks",
    ...
    #     """.split('\n') if c.strip()],
    # ],
    keywords='gis shapefile domain processing special',
